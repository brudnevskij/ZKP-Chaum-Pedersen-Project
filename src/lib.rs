...
impl ZKP {
    ...
    pub fn get_constants() -> (BigUint, BigUint, BigUint, BigUint) {
        ...
        let exp_hex = hex::decode("266FEA1E5C41564B777E69").unwrap();
        let exp = BigUint::from_bytes_be(&exp_hex);
...
mod test {
    ...
    #[test]
    fn test_toy_example_random_numbers() {
        let alpha = BigUint::from(4u32);
        let beta = BigUint::from(9u32);
        let p = BigUint::from(23u32);
        let q = BigUint::from(11u32);
    ...
    /*
     Source: https://datatracker.ietf.org/doc/html/rfc5114#section-2
    ...
    q =  801C0D34 C58D93FE 99717710 1F80535A 4738CEBC BF389A99
      ...
      */
    #[test]
    fn test_2048_bit_constants() {
        let p_hex=hex::decode("").unwrap();
        let p = BigUint::from_bytes_be(&p_hex);
        let q_hex =
            hex::decode("801C0D34C58D93FE997177101F80535A4738CEBCBF389A99B36371EB").unwrap();
        let q = BigUint::from_bytes_be(&q_hex);
        let alpha_hex = hex::decode("").unwrap();
        let alpha = BigUint::from_bytes_be(&alpha_hex);
        let beta = ZKP::exponentiate(&alpha, &ZKP::generate_random_below(&q), &p);
